...
| burnstarts | burner starts | uint24 (>=0<=16777214) |   | false | DEVICE_DATA | -1 | 2 | 1 | 
| burnworkmin | total burner operating time | time (>=0<=16777214) | minutes | false | DEVICE_DATA | -1 | 2 | 1 | 
| burn2workmin | burner stage 2 operating time | time (>=0<=16777214) | minutes | false | DEVICE_DATA | -1 | 2 | 1 | 
| heatworkmin | total heat operating time | time (>=0<=16777214) | minutes | false | DEVICE_DATA | -1 | 2 | 1 | 
| heatstarts | burner starts heating | uint24 (>=0<=16777214) |   | false | DEVICE_DATA | -1 | 2 | 1 | 
| ubauptime | total UBA operating time | time (>=0<=16777214) | minutes | false | DEVICE_DATA | -1 | 2 | 1 | 
...
| starts | starts | uint24 (>=0<=16777214) |   | false | DHW | -1 | 2 | 1 | 
| workm | active time | time (>=0<=16777214) | minutes | false | DHW | -1 | 2 | 1 | 
...
| totalcompstarts | total compressor control starts | uint24 (>=0<=16777214) |   | false | DEVICE_DATA | -1 | 2 | 1 | 
| heatingstarts | heating control starts | uint24 (>=0<=16777214) |   | false | DEVICE_DATA | -1 | 2 | 1 | 
| coolingstarts | cooling control starts | uint24 (>=0<=16777214) |   | false | DEVICE_DATA | -1 | 2 | 1 | 
| startshp | starts hp | uint24 (>=0<=16777214) |   | false | DHW | -1 | 2 | 1 | 
| poolstarts | pool control starts | uint24 (>=0<=16777214) |   | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgconstotal | total energy consumption | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgconscomptotal | total energy consumption compressor | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgconscompheating | energy consumption compressor heating | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgconscomp | energy consumption compressor | uint24 (>=0<=16777214) | kWh | false | DHW | -1 | 2 | 1 | 
| nrgconscompcooling | energy consumption compressor cooling | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgconscomppool | energy consumption compressor pool | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| auxelecheatnrgconstotal | total aux elec. heater energy consumption | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| auxelecheatnrgconsheating | aux elec. heater energy consumption heating | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| auxelecheatnrgcons | aux elec. heater energy consumption | uint24 (>=0<=16777214) | kWh | false | DHW | -1 | 2 | 1 | 
| auxelecheatnrgconspool | aux elec. heater energy consumption pool | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgsupptotal | total energy supplied | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgsuppheating | total energy supplied heating | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgsupp | total energy warm supplied | uint24 (>=0<=16777214) | kWh | false | DHW | -1 | 2 | 1 | 
| nrgsuppcooling | total energy supplied cooling | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
| nrgsupppool | total energy supplied pool | uint24 (>=0<=16777214) | kWh | false | DEVICE_DATA | -1 | 2 | 1 | 
...
| powerreduction | power reduction | uint8 (>=30<=60) | % | true | DEVICE_DATA | -1 | 1 | 10 | 
| hpsetdiffpress | set differential pressure | uint8 (>=150<=750) | mbar | true | DEVICE_DATA | -1 | 1 | 50 | 
| hpcompon | hp compressor | boolean |   | false | DEVICE_DATA | -1 | 1 | 1 | 
| hpactivity | compressor activity | enum [off\|heating\|cooling\|hot water\|pool\|pool heating\|defrost\|compressor alarm] |   | false | DEVICE_DATA | -1 | 1 | 1 | 
...
| auxheaterstatus | aux heater status | boolean |   | false | DEVICE_DATA | -1 | 1 | 1 | 
| auxheaterlevel | aux heater level | uint8 (>=0<=100) | % | false | DEVICE_DATA | -1 | 1 | 1 | 
...
| heatingpumpmod | heating pump modulation | uint8 (>=0<=100) | % | false | DEVICE_DATA | -1 | 1 | 1 | 
| hpcompspd | compressor speed | uint8 (>=0<=100) | % | false | DEVICE_DATA | -1 | 1 | 1 | 
| hybridstrategy | hybrid control strategy | enum [cost optimized\|co2 optimized\|outside temperature alt.\|outside temperature parallel\|heatpump preferred\|boiler only] |   | true | DEVICE_DATA | -1 | 1 | 1 | 
| lownoisemode | low noise mode | enum [off\|reduced output\|switch off hp\|perm. reduced] |   | true | DEVICE_DATA | -1 | 1 | 1 | 
| lownoisestart | low noise starttime | uint8 (>=0<=23) | hours | true | DEVICE_DATA | -1 | 1 | 1 | 
| lownoisestop | low noise stoptime | uint8 (>=0<=23) | hours | true | DEVICE_DATA | -1 | 1 | 1 | 
| hybriddhw | hybrid DHW | enum [eco\|high comfort] |   | true | DHW | -1 | 1 | 1 | 
| energypricegas | energy price gas | uint8 (>=0<=254) | ct/kWh | true | DEVICE_DATA | -1 | 1 | 1 | 
| energypriceel | energy price electric | uint8 (>=0<=254) | ct/kWh | true | DEVICE_DATA | -1 | 1 | 1 | 
| energyfeedpv | feed in PV | uint8 (>=0<=254) | ct/kWh | true | DEVICE_DATA | -1 | 1 | 1 | 
| switchovertemp | outside switchover temperature | int8 (>=-126<=126) | C | true | DEVICE_DATA | -1 | 1 | 1 | 
...
| heatingstarts | heating control starts | uint24 (>=0<=16777214) |   | false | DEVICE_DATA | -1 | 2 | 1 | 
| startshp | starts hp | uint24 (>=0<=16777214) |   | false | DHW | -1 | 2 | 1 | 
| fuelheat | fuel consumption heating | uint32 (>=0<=1677721) | kWh | false | DEVICE_DATA | -1 | 2 | 1/10 | 
| fueldhw | fuel consumption | uint32 (>=0<=1677721) | kWh | false | DHW | -1 | 2 | 1/10 | 
| elheat | el. consumption heating | uint32 (>=0<=1677721) | kWh | false | DEVICE_DATA | -1 | 2 | 1/10 | 
| eldhw | el. consumption | uint32 (>=0<=1677721) | kWh | false | DHW | -1 | 2 | 1/10 | 
| elgenheat | el. generation heating | uint32 (>=0<=1677721) | kWh | false | DEVICE_DATA | -1 | 2 | 1/10 | 
| elgendhw | el generation | uint32 (>=0<=1677721) | kWh | false | DHW | -1 | 2 | 1/10 | 
...
| shortname | fullname | type | uom | writeable | tag type | register offset | register count | scale factor |
|-|-|-|-|-|-|-|-|-|
| sysflowtemp | system flow temperature | int16 (>=-3199<=3199) | C | false | AHS | -1 | 1 | 1/10 | 
| sysrettemp | system return temperature | int16 (>=-3199<=3199) | C | false | AHS | -1 | 1 | 1/10 | 
| altflowtemp | alternative hs flow temperature | int16 (>=-3199<=3199) | C | false | AHS | -1 | 1 | 1/10 | 
| altrettemp | alternative hs return temperature | int16 (>=-3199<=3199) | C | false | AHS | -1 | 1 | 1/10 | 
| cyltoptemp | cylinder top temperature | int16 (>=-3199<=3199) | C | false | AHS | -1 | 1 | 1/10 | 
| cylcentertemp | cylinder center temperature | int16 (>=-3199<=3199) | C | false | AHS | -1 | 1 | 1/10 | 
| cylbottomtemp | cylinder bottom temperature | int16 (>=-3199<=3199) | C | false | AHS | -1 | 1 | 1/10 | 
| fluegastemp | flue gas temperature | int16 (>=-3199<=3199) | C | false | AHS | -1 | 1 | 1/10 | 
| valvebuffer | buffer valve | uint8 (>=0<=100) | % | false | AHS | -1 | 1 | 1 | 
| valvereturn | return valve | uint8 (>=0<=100) | % | false | AHS | -1 | 1 | 1 | 
| apumpmod | alternative hs pump modulation | uint8 (>=0<=100) | % | false | AHS | -1 | 1 | 1 | 
| vr2config | vr2 configuration | enum [off\|bypass] |   | true | AHS | -1 | 1 | 1 | 
| ahsactivated | alternate heat source activation | boolean |   | true | AHS | -1 | 1 | 1 | 
| apumpconfig | primary pump config | boolean |   | true | AHS | -1 | 1 | 1 | 
| apumpsignal | output for pr1 pump | enum [off\|pwm\|pwm inverse] |   | true | AHS | -1 | 1 | 1 | 
| apumpmin | min output pump pr1 | uint8 (>=12<=50) | % | true | AHS | -1 | 1 | 1 | 
| temprise | ahs return temp rise | boolean |   | true | AHS | -1 | 1 | 1 | 
| setreturntemp | set temp return | uint8 (>=40<=75) | C | true | AHS | -1 | 1 | 1 | 
| mixruntime | mixer run time | uint16 (>=0<=600) | seconds | true | AHS | -1 | 1 | 1 | 
| setflowtemp | set flow temperature | uint8 (>=40<=75) | C | true | AHS | -1 | 1 | 1 | 
| bufbypass | buffer bypass config | enum [no\|mixer\|valve] |   | true | AHS | -1 | 1 | 1 | 
| bufmixruntime | bypass mixer run time | uint16 (>=0<=600) | seconds | true | AHS | -1 | 1 | 1 | 
| bufconfig | dhw buffer config | enum [off\|monovalent\|bivalent] |   | true | AHS | -1 | 1 | 1 | 
| blockmode | config htg. blocking mode | enum [off\|auto\|blocking] |   | true | AHS | -1 | 1 | 1 | 
| blockterm | config of block terminal | enum [n_o\|n_c] |   | true | AHS | -1 | 1 | 1 | 
| blockhyst | hyst. for boiler block | int8 (>=0<=50) | C | true | AHS | -1 | 1 | 1 | 
| releasewait | boiler release wait time | uint8 (>=0<=240) | minutes | true | AHS | -1 | 1 | 1 | 
| burner | burner | boolean |   | false | AHS | -1 | 1 | 1 | 
| apump | alternative hs pump | boolean |   | false | AHS | -1 | 1 | 1 | 
| heatrequest | heat request | uint8 (>=0<=100) | % | false | AHS | -1 | 1 | 1 | 
| blockremain | remaining blocktime | uint8 (>=0<=254) | minutes | false | AHS | -1 | 1 | 1 | 
| blockremaindhw | remaining blocktime dhw | uint8 (>=0<=254) | minutes | false | AHS | -1 | 1 | 1 | 
...
| pumpworktime | pump working time | time (>=0<=16777214) | minutes | false | DEVICE_DATA | -1 | 2 | 1 | 
...
| cyl3bottomtemp | third cylinder bottom temperature (TS11) | int16 (>=-3199<=3199) | C | false | DEVICE_DATA | -1 | 1 | 1/10 | 
| cyltoptemp | cylinder top temperature (TS10) | int16 (>=-3199<=3199) | C | false | DEVICE_DATA | -1 | 1 | 1/10 | 
...
| vs3status | valve status VS3 | boolean |   | false | DEVICE_DATA | -1 | 1 | 1 | 
| transferpump | transfer pump | boolean |   | false | DEVICE_DATA | -1 | 1 | 1 | 
| transferpumpmod | transfer pump modulation | uint8 (>=0<=100) | % | false | DEVICE_DATA | -1 | 1 | 1 | 
...
| energylasthour | energy last hour | uint24 (>=0<=1677721) | Wh | false | DEVICE_DATA | -1 | 2 | 1/10 | 
| energytoday | total energy today | uint24 (>=0<=16777214) | Wh | false | DEVICE_DATA | -1 | 2 | 1 | 
| energytotal | total energy | uint24 (>=0<=1677721) | kWh | false | DEVICE_DATA | -1 | 2 | 1/10 | 
| pump2worktime | pump 2 working time | time (>=0<=16777214) | minutes | false | DEVICE_DATA | -1 | 2 | 1 | 
| m1worktime | differential control working time | time (>=0<=16777214) | minutes | false | DEVICE_DATA | -1 | 2 | 1 | 
...
| mode | operating mode | enum [manual\|auto] |   | false | HC | -1 | 1 | 1 | 
...
| absent | absent | boolean |   | true | DEVICE_DATA | -1 | 1 | 1 | 
| seltemp | selected room temperature | int16 (>=0<=30) | C | true | HC | -1 | 1 | 1/2 | 
| currtemp | current room temperature | int16 (>=-3199<=3199) | C | false | HC | -1 | 1 | 1/10 | 
| haclimate | mqtt discovery current room temperature | enum [selTemp\|roomTemp] (>=5<=30) |   | false | HC | -1 | 1 | 1 | 
...
| redthreshold | reduction threshold | int8 (>=12<=22) | C | true | HC | -1 | 1 | 1/2 | 
...
| charge | charge | boolean |   | true | DHW | -1 | 1 | 1 | 
| extra | extra | boolean |   | false | DHW | -1 | 1 | 1 | 
| disinfecting | disinfecting | boolean |   | true | DHW | -1 | 1 | 1 | 
| disinfectday | disinfection day | enum [mo\|tu\|we\|th\|fr\|sa\|su\|all] |   | true | DHW | -1 | 1 | 1 | 
...
| curtemp2 | current extern temperature | uint16 (>=0<=3199) | C | false | DHW | -1 | 1 | 1/10 | 
| hydrTemp | hydraulic header temperature | uint16 (>=0<=3199) | C | false | DHW | -1 | 1 | 1/10 | 
| pump | pump | boolean |   | false | DHW | -1 | 1 | 1 | 
| flowtempoffset | flow temperature offset | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| hyston | hysteresis on temperature | int8 (>=-126<=126) | C | true | DHW | -1 | 1 | 1 | 
| hystoff | hysteresis off temperature | int8 (>=-126<=126) | C | true | DHW | -1 | 1 | 1 | 
| disinfectiontemp | disinfection temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| circ | circulation active | boolean |   | true | DHW | -1 | 1 | 1 | 
| circmode | circulation pump mode | enum [off\|on\|auto\|own prog] |   | true | DHW | -1 | 1 | 1 | 
...
|-|-|-|-|-|-|-|-|-|
| temp | current temperature | uint16 (>=0<=3199) | C | false | DHW | -1 | 1 | 1/10 | 
| tempstatus | temperature switch in assigned dhw (MC1) | int8 (>=-126<=126) |   | false | DHW | -1 | 1 | 1 | 
| pump | pump | boolean |   | false | DHW | -1 | 1 | 1 | 
| maxtemp | maximum temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| difftemp | start differential temperature | int8 (>=-126<=126) | C | true | DHW | -1 | 1 | 1 | 
| disinfectiontemp | disinfection temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| redtemp | reduced temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| requiredtemp | required temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| circ | circulation active | boolean |   | true | DHW | -1 | 1 | 1 | 
| circmode | circulation pump mode | enum [off\|on\|auto\|own prog] |   | true | DHW | -1 | 1 | 1 | 
...
| temp | current temperature | uint16 (>=0<=3199) | C | false | DHW | -1 | 1 | 1/10 | 
| storagetemp1 | storage intern temperature | uint16 (>=0<=3199) | C | false | DHW | -1 | 1 | 1/10 | 
| coldtemp | cold water | uint16 (>=0<=3199) | C | false | DHW | -1 | 1 | 1/10 | 
| temp5 | temperature 5 | uint16 (>=0<=3199) | C | false | DHW | -1 | 1 | 1/10 | 
| rettemp | return temperature | uint16 (>=0<=3199) | C | false | DHW | -1 | 1 | 1/10 | 
| pump | pump | boolean |   | false | DHW | -1 | 1 | 1 | 
| maxtemp | maximum temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| seltemp | selected temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| redtemp | reduced temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| hottemp | extra hot temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| dailytemp | daily temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| disinfectiontemp | disinfection temperature | uint8 (>=0<=254) | C | true | DHW | -1 | 1 | 1 | 
| circ | circulation active | boolean |   | true | DHW | -1 | 1 | 1 | 
| circmode | circulation pump mode | enum [off\|1x3min\|2x3min\|3x3min\|4x3min\|5x3min\|6x3min\|continuous] |   | true | DHW | -1 | 1 | 1 | 
| circtc | circulation time controled | boolean |   | true | DHW | -1 | 1 | 1 | 
| keepwarm | keep warm | boolean |   | true | DHW | -1 | 1 | 1 | 
| status2 | status 2 | enum [\|\|\|no heat\|\|\|heat request\|\|disinfecting\|hold] |   | false | DHW | -1 | 1 | 1 | 
| pumpmod | pump modulation | uint8 (>=0<=100) | % | false | DHW | -1 | 1 | 1 | 
| flow | flow rate | uint16 (>=0<=3199) | l/min | false | DHW | -1 | 1 | 1/10 | 
| valvereturn | return valve | uint8 (>=0<=100) | % | true | DHW | -1 | 1 | 1 | 
| deltatret | temp. diff. return valve | uint8 (>=0<=254) | K | true | DHW | -1 | 1 | 1 | 
| errordisp | error display | enum [off\|normal\|inverted] |   | true | DHW | -1 | 1 | 1 | 
