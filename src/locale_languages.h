...
MAKE_PSTR_LIST(unknown, F("unknown"))
...
MAKE_PSTR_LIST(disinfecting, F("disinfecting")) // DE
MAKE_PSTR_LIST(no_heat, F("no heat")) // DE
MAKE_PSTR_LIST(heatrequest, F("heat request")) // DE

// heatpump
MAKE_PSTR_LIST(none, F("none")) // DE
MAKE_PSTR_LIST(hot_water, F("hot water")) // DE
