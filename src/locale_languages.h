...
MAKE_PSTR_LIST(oilPreHeat, F("oilpreheat"), F("oil preheating"), F("oil preheating"))
...
MAKE_PSTR_LIST(auxElecHeatNrgConsTotal, F("auxelecheatnrgconstotal"), F("total auxiliary electrical heater energy consumption"),F("Energieverbrauch el. Zusatzheizung"))
MAKE_PSTR_LIST(auxElecHeatNrgConsHeating, F("auxelecheatnrgconsheating"), F("auxiliary electrical heater energy consumption heating"),F("Energieverbrauch el. Zusatzheizung Heizen"))
...
MAKE_PSTR_LIST(auxElecHeatNrgConsPool, F("auxelecheatnrgconspool"), F("auxiliary electrical heater energy consumption pool"),F("Energieverbrauch el. Zusatzheizung Pool"))

MAKE_PSTR_LIST(hpPower, F("hppower"), F("compressor power output"),F("Leistung Wärmepumpe"))
MAKE_PSTR_LIST(hpCompOn, F("hpcompon"), F("hp compressor"),F("HP Compressor"))
MAKE_PSTR_LIST(hpHeatingOn, F("hpheatingon"), F("hp heating"),F("HP Heating"))
MAKE_PSTR_LIST(hpCoolingOn, F("hpcoolingon"), F("hp cooling"),F("HP Cooling"))
MAKE_PSTR_LIST(hpWwOn, F("hpwwon"), F("hp dhw"),F("HP dhw"))
MAKE_PSTR_LIST(hpPoolOn, F("hppoolon"), F("hp pool"),F("HP Pool"))
MAKE_PSTR_LIST(hpBrinePumpSpd, F("hpbrinepumpspd"), F("brine pump speed"),F("Brine Pump Speed"))
MAKE_PSTR_LIST(hpCompSpd, F("hpcompspd"), F("compressor speed"),F("Compressor Speed"))
MAKE_PSTR_LIST(hpCircSpd, F("hpcircspd"), F("circulation pump speed"),F("Circulation pump Speed"))
MAKE_PSTR_LIST(hpBrineIn, F("hpbrinein"), F("brine in/evaporator"),F("Brine in/Evaporator"))
MAKE_PSTR_LIST(hpBrineOut, F("hpbrineout"), F("brine out/condenser"),F("Brine out/Condenser"))
MAKE_PSTR_LIST(hpSuctionGas, F("hpsuctiongas"), F("suction gas"),F("Suction gas"))
MAKE_PSTR_LIST(hpHotGas, F("hphotgas"), F("hot gas/compressed"),F("Hot gas/Compressed"))
MAKE_PSTR_LIST(hpSwitchValve, F("hpswitchvalve"), F("switch valve"),F("Switch Valve"))
MAKE_PSTR_LIST(hpActivity, F("hpactivity"), F("compressor activity"),F("Compressor Activity"))
...
// hybrid heatpump
MAKE_PSTR_LIST(hybridStrategy, F("hybridstrategy"), F("hybrid control strategy")) // DE
MAKE_PSTR_LIST(switchOverTemp, F("switchovertemp"), F("outside switchover temperature")) // DE
MAKE_PSTR_LIST(energyCostRatio, F("energycostratio"), F("energy cost ratio")) // DE
MAKE_PSTR_LIST(fossileFactor, F("fossilefactor"), F("fossile energy factor")) // DE
MAKE_PSTR_LIST(electricFactor, F("electricfactor"), F("electric energy factor")) // DE
MAKE_PSTR_LIST(delayBoiler, F("delayboiler"), F("delay boiler support")) // DE
MAKE_PSTR_LIST(tempDiffBoiler, F("tempdiffboiler"), F("tempdiff boiler support")) // DE

// alternative heatsource AM200
MAKE_PSTR_LIST(aCylTopTemp, F("cyltoptemp"), F("cylinder top temperature")) // DE
MAKE_PSTR_LIST(aCylCenterTemp, F("cylcentertemp"), F("cylinder center temperature")) // DE
MAKE_PSTR_LIST(aCylBottomTemp, F("cylbottomtemp"), F("cylinder bottom temperature")) // DE
MAKE_PSTR_LIST(aFlowTemp, F("altflowtemp"), F("alternative hs flow temperature")) // DE
MAKE_PSTR_LIST(aRetTemp, F("altrettemp"), F("alternative hs return temperature")) // DE
MAKE_PSTR_LIST(sysFlowTemp, F("sysflowtemp"), F("system flow temperature")) // DE
MAKE_PSTR_LIST(sysRetTemp, F("sysrettemp"), F("system return temperature")) // DE
MAKE_PSTR_LIST(valveByPass, F("valvebypass"), F("bypass valve")) // DE
MAKE_PSTR_LIST(valveBuffer, F("valvebuffer"), F("buffer valve")) // DE
MAKE_PSTR_LIST(valveReturn, F("valvereturn"), F("return valve")) // DE
MAKE_PSTR_LIST(aPump, F("altpump"), F("alternative hs pump")) // DE
MAKE_PSTR_LIST(heatSource, F("heatsource"), F("alternative heating active")) // DE
...
MAKE_PSTR_LIST(wwSelTempLow, F("wwseltemplow"), F("selected lower temperature")) // DE
MAKE_PSTR_LIST(wwSelTempOff, F("wwseltempoff"), F("selected temperature for off")) // DE
MAKE_PSTR_LIST(wwSelTempSingle, F("wwseltempsingle"), F("single charge temperature")) // DE
...
MAKE_PSTR_LIST(wwCylMiddleTemp, F("wwcylmiddletemp"), F("cylinder middle temperature (TS3)")) // DE
...
MAKE_PSTR_LIST(backlight, F("backlight"), F("key backlight")) // DE
...
MAKE_PSTR_LIST(wwCharge, F("wwcharge"), F("charge")) // DE
MAKE_PSTR_LIST(wwChargeDuration, F("wwchargeduration"), F("charge duration")) // DE
MAKE_PSTR_LIST(wwDisinfect, F("wwdisinfect"), F("disinfection")) // DE
MAKE_PSTR_LIST(wwDisinfectDay, F("wwdisinfectday"), F("disinfection day")) // DE
MAKE_PSTR_LIST(wwDisinfectHour, F("wwdisinfecthour"), F("disinfection hour")) // DE
MAKE_PSTR_LIST(wwDisinfectTime, F("wwdisinfecttime"), F("disinfection time")) // DE
...
MAKE_PSTR_LIST(wwDailyHeating, F("wwdailyheating"), F("daily heating")) // DE
MAKE_PSTR_LIST(wwDailyHeatTime, F("wwdailyheattime"), F("daily heating time")) // DE
...
MAKE_PSTR_LIST(fastheatup, F("fastheatup"), F("fast heatup")) // DE
...
MAKE_PSTR_LIST(wwHolidays, F("wwholidays"), F("holiday dates")) // DE
MAKE_PSTR_LIST(wwVacations, F("wwvacations"), F("vacation dates")) // DE
MAKE_PSTR_LIST(holidays, F("holidays"), F("holiday dates")) // DE
MAKE_PSTR_LIST(vacations, F("vacations"), F("vacation dates")) // DE
...
MAKE_PSTR_LIST(wwprio, F("wwprio"), F("dhw priority")) // DE
...
MAKE_PSTR_LIST(nofrostmode1, F("nofrostmode1"), F("nofrost mode")) // DE
MAKE_PSTR_LIST(remotetemp, F("remotetemp"), F("room temperature from remote"),F("Raumtemperatur der Fernsteuerung"))
MAKE_PSTR_LIST(reducehours, F("reducehours"), F("duration for nighttemp")) // DE
MAKE_PSTR_LIST(reduceminutes, F("reduceminutes"), F("remaining time for nightmode")) // DE
MAKE_PSTR_LIST(switchonoptimization, F("switchonoptimization"), F("switch-on optimization")) // DE
...
MAKE_PSTR_LIST(mixerSetTime, F("valvesettime"), F("time to set valve"),F("time to set valve"))
...
// mixer pool
MAKE_PSTR_LIST(poolSetTemp, F("poolsettemp"), F("pool set temperature")) // DE
MAKE_PSTR_LIST(poolTemp, F("pooltemp"), F("pool temperature")) // DE
MAKE_PSTR_LIST(poolShuntStatus, F("poolshuntstatus"), F("pool shunt status opening/closing")) // DE
MAKE_PSTR_LIST(poolShunt, F("poolshunt"), F("pool shunt open/close (0% = pool / 100% = heat)")) // DE
MAKE_PSTR_LIST(hydrTemp, F("hydrTemp"), F("hydraulic header temperature")) // DE
...
MAKE_PSTR_LIST(cylMiddleTemp, F("cylmiddletemp"), F("cylinder middle temperature (TS3)"),F("cylinder middle temperature (TS3)"))
MAKE_PSTR_LIST(retHeatAssist, F("retheatassist"), F("return temperature heat assistance (TS4)"),F("return temperature heat assistance (TS4)"))
MAKE_PSTR_LIST(m1Valve, F("heatassistvalve"), F("heat assistance valve (M1)"),F("heat assistance valve (M1)"))
MAKE_PSTR_LIST(m1Power, F("heatassistpower"), F("heat assistance valve power (M1)"),F("heat assistance valve power (M1)"))
...
MAKE_PSTR_LIST(pumpMinMod, F("pumpminmod"), F("minimum pump modulation")) // DE
MAKE_PSTR_LIST(maxFlow, F("maxflow"), F("maximum solar flow")) // DE
MAKE_PSTR_LIST(solarPower, F("solarpower"), F("actual solar power")) // DE
MAKE_PSTR_LIST(solarPumpTurnonDiff, F("turnondiff"), F("pump turn on difference")) // DE
MAKE_PSTR_LIST(solarPumpTurnoffDiff, F("turnoffdiff"), F("pump turn off difference")) // DE
MAKE_PSTR_LIST(pump2MinMod, F("pump2minmod"), F("minimum pump 2 modulation")) // DE
MAKE_PSTR_LIST(solarPump2TurnonDiff, F("turnondiff2"), F("pump 2 turn on difference")) // DE
MAKE_PSTR_LIST(solarPump2TurnoffDiff, F("turnoffdiff2"), F("pump 2 turn off difference")) // DE
...
MAKE_PSTR_LIST(solarPumpKick, F("pumpkick"), F("pumpkick"),F("pumpkick"))
...
MAKE_PSTR_LIST(solarPump2Kick, F("pump2kick"), F("pumpkick 2"),F("pumpkick 2"))

// telegram 0x035F
MAKE_PSTR_LIST(cylPriority, F("cylpriority"), F("cylinder priority"),F("Speicher Priorität"))

// telegram 0x380
MAKE_PSTR_LIST(climateZone, F("climatezone"), F("climate zone")) // DE
...
MAKE_PSTR_LIST(data11, F("data11"), F("unknown datafield 11")) // DE
MAKE_PSTR_LIST(data12, F("data12"), F("unknown datafield 12")) // DE
MAKE_PSTR_LIST(data8, F("data8"), F("unknown datafield 8")) // DE
MAKE_PSTR_LIST(data0, F("data0"), F("unknown datafield 0")) // DE
MAKE_PSTR_LIST(data1, F("data1"), F("unknown datafield 1")) // DE
MAKE_PSTR_LIST(setting3, F("setting3"), F("unknown setting 3")) // DE
MAKE_PSTR_LIST(setting4, F("setting4"), F("unknown setting 4")) // DE
